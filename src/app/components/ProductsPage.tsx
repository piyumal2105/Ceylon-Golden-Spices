      ...
      >
        <motion.div
          ...
          style={{
            width: '100%',
            maxWidth: '700px',
            /* ── KEY FIX: fixed height so tabs NEVER resize the modal ── */
        ...
        >
          ...
          <div className="relative shrink-0" style={{ height: '220px' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 px-5 pb-4">
              <p className="text-[10px] font-bold tracking-widest uppercase text-[#D4AF37] mb-1 opacity-95">
          ...
          <div className="flex border-b border-gray-100 bg-white shrink-0">
            {tabs.map(tab => (
              <button
                ...
                className={`flex-1 py-2.5 text-xs font-semibold transition-all ${activeTab === tab.id
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            ...
            {activeTab === 'overview' && (
              <div className="p-5 flex flex-col gap-3">
                <div className="flex gap-3 p-3 bg-[#FFF8E7] rounded-xl shrink-0">
                  <div className="text-center flex-1">
                    <MapPin className="w-3.5 h-3.5 text-[#D4AF37] mx-auto mb-0.5" />
                    <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Origin</p>
                    <p className="text-[11px] text-[#7B3F00] font-semibold">{product.origin}</p>
                  </div>
                  <div className="w-px bg-[#D4AF37]/20" />
                  <div className="text-center flex-1">
                    <MapPin className="w-3.5 h-3.5 text-[#D4AF37] mx-auto mb-0.5" />
                    <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Region</p>
                    <p className="text-[11px] text-[#7B3F00] font-semibold">{product.region}</p>
                  </div>
                  <div className="w-px bg-[#D4AF37]/20" />
                  <div className="text-center flex-1">
                    <Clock className="w-3.5 h-3.5 text-[#D4AF37] mx-auto mb-0.5" />
                    <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wide">Shelf Life</p>
                    <p className="text-[11px] text-[#7B3F00] font-semibold">{product.shelfLife}</p>
                  </div>
                </div>

                <p className="text-xs text-gray-600 leading-relaxed">{product.fullDescription}</p>

                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 border border-[#D4AF37]/20 rounded-xl bg-[#FFF8E7]/50">
                    <p className="text-[10px] font-bold text-[#7B3F00] uppercase tracking-wide mb-1">Flavour Profile</p>
                    <p className="text-[11px] text-gray-700 leading-snug">{product.flavourProfile}</p>
                  </div>
                  <div className="p-3 border border-[#D4AF37]/20 rounded-xl bg-[#FFF8E7]/50">
                    <p className="text-[10px] font-bold text-[#7B3F00] uppercase tracking-wide mb-1">Culinary Uses</p>
                    <p className="text-[11px] text-gray-700 leading-snug">{product.culinaryUses}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 pt-1">
                  <div>
                    <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wide mb-1.5">Select Size</p>
            ...
            {activeTab === 'nutrition' && (
              <div className="p-5 flex flex-col gap-3">
                <div className="p-4 bg-[#FFF8E7] rounded-xl border border-[#D4AF37]/20">
                  ...
                  <p className="text-sm text-gray-700">{product.nutrition}</p>
                </div>
